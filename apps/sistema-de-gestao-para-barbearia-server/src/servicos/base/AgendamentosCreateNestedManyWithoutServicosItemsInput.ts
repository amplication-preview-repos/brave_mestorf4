...
@InputType()
class AgendamentosCreateNestedManyWithoutServicosItemsInput {
...
export { AgendamentosCreateNestedManyWithoutServicosItemsInput as AgendamentosCreateNestedManyWithoutServicosItemsInput };
